...
const assertions = [
  ...
  { label: 'Dashboard finance summary reads canonical financial performance including current cash balance', file: 'app/finance/FinancialCommandSummary.tsx', all: ["rpc('get_financial_performance'", 'currentCashBalance'] },
  { label: 'Automation page remains permission-protected and backed by persisted control state/logs', file: 'app/business-intelligence/automation/page.tsx', all: ['AutomationControlCentre', 'system_intelligence_settings', 'automation_execution_log'] },
  { label: 'Automation Control Centre preserves kill switch, DRY RUN and explicit confirmation before live execution', file: 'app/business-intelligence/automation/AutomationControlCentre.tsx', all: ['automation_global_enabled', 'automation_mode_active', 'automation_competitor_enabled', '.upsert(', 'window.confirm', 'DRY RUN', 'STOP ALL'] },
