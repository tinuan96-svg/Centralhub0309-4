...
export default function Sidebar({ collapsed: manualCollapsed = false, onToggleCollapse }: SidebarProps) {
  ...
  useEffect(() => {
    const sections = [
      ...
      { key: '04 — products', paths: ['/inventory', '/inventory/intelligence', '/inventory/bulk', '/inventory/categories', '/inventory/brands', '/settings/master-data/categories', '/settings/master-data/brands', '/inventory-management/sync'] },
  ...
  const allNavItems = useMemo(() => [
    ...
    { label: 'Products', icon: '📦', key: '04 — products', subItems: [{ href: '/inventory', label: 'Product Manager' }, { href: '/inventory/intelligence', label: 'Product Intelligence' }, { href: '/inventory/categories', label: 'Categories & Sales' }, { href: '/inventory/brands', label: 'Brands & Sales' }, { href: '/inventory/bulk', label: 'Bulk Manager' }, { href: '/business-intelligence/executive#approvals', label: 'Product Approvals' }, { href: '/marketing/ai', label: 'SEO & Content' }, { href: '/inventory-management/sync', label: 'Product Sync' }] },
