...
export default function MobileHeader() {
  ...
  const allNavItems = useMemo(() => [
    ...
    { label: 'Pricing', icon: '🏷️', key: '11.5 — pricing', subItems: [
    ...
    { label: 'HR & Payroll', icon: '👥', key: '12.25 — hr & payroll', subItems: [
      { href: '/hr-payroll', label: 'HR Dashboard' },
      { href: '/hr-payroll/employees', label: 'Employees' },
      { href: '/hr-payroll/attendance', label: 'Attendance (Review Only)' },
      { href: '/hr-payroll/shifts', label: 'Shifts (Upcoming)' },
      { href: '/hr-payroll/leave', label: 'Leave (Review Only)' },
      { href: '/hr-payroll/sponsor-compliance', label: 'Sponsor Compliance (Review Only)' },
      { href: '/hr-payroll/payroll', label: 'Payroll (Drafts Only)' },
      { href: '/hr-payroll/payslips', label: 'Payslips (Upcoming)' },
      { href: '/hr-payroll/pensions', label: 'Pensions (Upcoming)' },
      { href: '/hr-payroll/hmrc-paye', label: 'HMRC / PAYE (Upcoming)' },
      { href: '/hr-payroll/reports', label: 'Reports (Upcoming)' },
      { href: '/hr-payroll/settings', label: 'Settings (Upcoming)' },
    ] },
