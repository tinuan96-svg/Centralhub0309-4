...
// Fixed product identity rule:
// - every sellable weight/size is a separate products row / physical SKU;
// - variant_group_key links sibling SKUs for storefront presentation only;
