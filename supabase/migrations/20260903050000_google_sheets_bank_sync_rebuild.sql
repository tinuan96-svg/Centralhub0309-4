...
CREATE INDEX IF NOT EXISTS idx_bank_transactions_account_reference
  ON public.bank_transactions(bank_account_id, reference);
CREATE INDEX IF NOT EXISTS idx_bank_transactions_account_datetime
  ON public.bank_transactions(bank_account_id, transaction_date DESC, transaction_time DESC);
...
WHERE bank_name = 'Monzo'
  AND account_name = 'Monzo Business Account';
