  ...
  return (
    <section className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden">
      <div className="p-5 border-b border-slate-800 flex justify-between items-center">
        <div><h2 className="section-title">Financial Performance</h2><p className="section-help">Actual trading performance used as the financial baseline for pricing decisions.</p></div>
      ...
      {loading ? <div className="p-10 text-center text-slate-500">Calculating financial performance…</div> : (
