...
const links = [
  ['/finance', 'Overview'], ['/finance/planning', 'Planning & Growth'], ['/finance/admin-intake', 'WhatsApp Intake'], ['/finance/reserves', 'Reserves'], ['/finance/reserve-controls', 'Reserve Rules'], ['/finance/ledger', 'Chart of Accounts'], ['/finance/transactions', 'Bank Reconciliation'], ['/finance/payables', 'Supplier Payables'], ['/finance/p-and-l', 'Profit & Loss'], ['/finance/profitability', 'Profitability'],
];
