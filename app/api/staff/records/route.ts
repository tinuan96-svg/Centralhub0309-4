...
const resources={
  ...
  finance:{permission:'finance.view',table:'bank_transactions',columns:'id,store_id,description,amount,type,accounting_category,classification_status,is_reconciled,created_at'},
